      ...
      <main className="flex-1 mx-auto w-full max-w-lg px-4 pt-8 pb-10 flex flex-col items-center text-center gap-6">
        ...
        {status !== 'loading' && (
          <div className="w-full space-y-3">
            ...
            {!isLoggedIn && (
              <div className="relative">
                <div className="rounded-2xl border border-yellow-700/40 bg-yellow-950/20 px-5 py-5 flex flex-col items-center gap-3 text-center">
                  <p className="text-sm font-extrabold text-white">Regístrate gratis para ver<br /><span style={{color:GOLD}}>las marcas de los 10 mejores expertos</span></p>
                  <Link href="/auth/signin?mode=register"
